...
### #1 [MolmoMotion：语言引导的3D运动预测模型](https://huggingface.co/blog/allenai/molmomotion)
...
### #2 [Grok 4.3 在 Amazon Bedrock 正式可用](https://x.ai/news/grok-amazon-bedrock)
...
### #3 [Vercel 发布开源 AI 智能体框架 Eve：每个智能体就是一个文件目录](https://www.marktechpost.com/2026/06/17/vercel-releases-eve)
...
### #4 [Omnigent开源：AI智能体团队元框架](https://x.com/Yuchenj_UW/status/2067273020352380950)
...
### #5 [Google发布99美元Gemini智能音箱](https://techcrunch.com/2026/06/17/google-bets-on-gemini-to-reinvent-the-smart-home-speaker)
...
### #6 [Wolfram 语言和 Mathematica 15 版发布：内置 AI 助手、符号音乐等新功能](https://writings.stephenwolfram.com/2026/06/launching-version-15-of-wolfram-language-mathematica-built-in-useful-ai-lots-of-new-core-functionality)
...
### #7 [阿里云发布HappyOyster 1.0：一句话生成可实时交互的数字世界](https://www.ithome.com/0/965/652.htm)
...
### #8 [Claude Design 更新：跨项目保持品牌一致，与Claude Code协同](https://claude.com/blog/claude-design-stays-on-brand-for-daily-work)
...
### #9 [Claude Design与Replit联动，设计变应用](https://x.com/Replit/status/2067328501003497684)

>在Claude中设计。在Replit中构建。 你现在可以将Claude Design中的设计发送到Replit，将其变成一个可工作的应用。

### #10 [Strands Robots SDK：用单一智能体打通 Hugging Face Hub 到物理机器人](https://huggingface.co/blog/amazon/strands-lerobot-hub-to-hardware)
...
### #11 [Anthropic与DeepMind CEO呼吁G7组建AI联盟排除中国](https://x.com/kimmonismus/status/2067310431669223425)
...
### #12 [泄露文件显示OpenAI年营收130亿但亏损远超收入](https://arstechnica.com/ai/2026/06/leaked-financial-docs-show-openai-is-losing-billions-of-dollars-a-year)
...
### #13 [消息称 OpenAI 今年一季度现金消耗达 37 亿美元，超同期收入的一半](https://www.ithome.com/0/965/335.htm)
...
### #14 [中国加紧筹建世界人工智能合作组织](https://www.ithome.com/0/965/248.htm)
...
### #15 [谷歌发布Agentic Resource Discovery（ARD）开放规范](https://developers.googleblog.com/announcing-the-agentic-resource-discovery-specification)
...
### #16 [Databricks 扩大对 Snowflake 的领先优势](https://www.tomtunguz.com/databricks-widens-lead)
...
### #17 [Claude Opus 4.8 Build Day黑客马拉松获奖项目揭晓](https://claude.com/blog/meet-the-winners-of-our-claude-opus-4-8-build-day-hackathon)
...
### #18 [Anthropic 在首尔开设办公室并宣布多项韩国AI生态合作](https://www.anthropic.com/news/seoul-office-partnerships-korean-ai-ecosystem)
...
### #19 [NVIDIA GEAR实验室发布ENPIRE：8个Codex智能体自主控制机器人完成物理实验](https://x.com/DrJimFan/status/2067283904986517866)
...
### #20 [用SGLang-JAX在TPU上优化Ling-2.6-1T：一个Pallas核将MoE数据移动隐藏在计算中](https://www.lmsys.org/blog/2026-06-17-ling-2-6-tpu)
...
### #21 [LifeSciBench 发布](https://openai.com/index/introducing-life-sci-bench)
...
### #22 [Google 医学推理 AI 系统 AMIE 新研究：从诊断迈向长期疾病管理](https://blog.google/innovation-and-ai/models-and-research/google-research/amie-for-disease-management-in-nature)
...
### #23 [OpenAI 与 Molecule.one 合作：GPT‑5.4 自主优化 Chan‑Lam 偶联反应](https://openai.com/index/ai-chemist-improves-reaction)
...
### #24 [Matt Pocock 开源 skills v1：将技能描述 Token 成本降低 63%](https://x.com/AYi_AInotes/status/2067327021005656135)
...
### #25 [baoyu-design 本地动画视频导出功能更新](https://x.com/dotey/status/2067039941960327204)
...
### #26 [Google 分享 A2UI 与 MCP Apps 三种集成架构模式](https://developers.googleblog.com/a2ui-and-mcp-apps)
...
### #27 [预训练还不够“苦涩”](https://blog.ml.cmu.edu/2026/06/17/pre-training-isnt-bitter-enough)
...
### #28 [博客现状，2026年中](https://www.interconnects.ai/p/state-of-the-blog-mid-2026)
...
### #29 [特朗普向Anthropic提出不可能的要求](https://garymarcus.substack.com/p/breaking-trump-asks-the-impossible)
...
*数据来源：[AI HOT](https://aihot.virxact.com) · 多 Agent 流水线自动生成*