...
### #2 [Qwen-RobotManip：对齐解锁机器人操作基础模型的规模化能力](https://qwen.ai/blog?id=qwen-robotmanip)
...
### #3 [Qwen-RobotWorld：具身智能体的无界世界](https://qwen.ai/blog?id=qwen-robotworld)
...
### #4 [成本砍半，字节跳动推出 Seedance 2.0 Mini 视频生成模型](https://www.ithome.com/0/964/672.htm)
...
### #5 [Qwen-RobotNav：面向智能体导航系统的可扩展导航模型](https://qwen.ai/blog?id=qwen-robotnav)
...
### #6 [教育部“阳光志愿”信息服务系统全新升级上线：智能筛选志愿，数据权威可信](https://www.ithome.com/0/964/675.htm)
...
### #7 [Google Cloud 推出 OKF v0.1：供应商中立的 Markdown 规范，为 AI 智能体提供结构化上下文](https://www.marktechpost.com/2026/06/16/google-cloud-introduces-open-knowledge-format-okf-a-vendor-neutral-markdown-spec-for-giving-ai-agents-curated-context)
...
### #9 [AI 版支付宝官宣开启邀测：右滑打开“阿宝”，官方放出 100 个邀请码](https://www.ithome.com/0/964/691.htm)
...
### #10 [小米 MiMo Claw 正式版发布：旗舰模型+金山办公，全新订阅服务上线](https://mp.weixin.qq.com/s/N5ac768a8LkhEjOVpkR1dQ)
...
### #11 [Subagent：让模型把琐碎任务委托出去](https://openrouter.ai/blog/announcements/subagent-server-tool)
...
### #12 [Midjourney V8.1 推出 Draft mode 草稿模式与新功能预览](https://updates.midjourney.com/draft-mode-for-v8-1-and-new-feature-previews)

>Midjourney V8.1 的 Draft mode 草稿模式每次生成24张低分辨率低质量图片。用户可对任意图片点击 "Vary"，将其渲染为全质量、全分辨率版本。草稿任务消耗的快速小时数减半。

### #13 [Grok for PowerPoint 发布：在 Microsoft PowerPoint 内直接生成和编辑幻灯片](https://x.ai/news/introducing-powerpoint-addin)
...
### #14 [美国司法部援引国家安全为xAI未经许可的燃气轮机辩护](https://the-decoder.com/doj-invokes-national-security-to-defend-xais-unpermitted-gas-turbines-in-naacp-lawsuit)
...
### #15 [五角大楼将大部分日常AI工作流从Anthropic转移，目标9月前完全切断](https://x.com/AYi_AInotes/status/2066679835607412846)
...
### #16 [微软旗下GitHub遭遇AI算力短缺，转而向AWS寻求支持](https://runtimewire.com/article/microsoft-github-aws-ai-capacity-crunch)
...
### #17 [微软考虑为 Copilot Cowork 集成 DeepSeek V4](https://x.com/kimmonismus/status/2066946013026263110)
...
### #18 [Fable 遭美国政府封禁，TechCrunch 质疑真正原因并非模型越狱](https://techcrunch.com/2026/06/15/the-us-governments-anthropic-models-ban-was-never-about-an-ai-jailbreak)

>美国政府对 Anthropic 的模型 Fable 实施封禁，但 TechCrunch 发文质疑，实际原因可能并非此前认为的“模型越狱”问题。该文章在 Hacker News 引发讨论，获得 103 个点赞。

### #19 [SpaceX 以 600 亿美元股票收购 AI 编程公司 Cursor](https://techcrunch.com/2026/06/16/spacex-to-acquire-cursor-for-60b-in-stock-days-after-blockbuster-ipo)
...
### #20 [Anthropic 5月企业AI订阅份额首超OpenAI，特朗普政府禁令反促采用量创新高](https://techcrunch.com/2026/06/16/anthropics-latest-feud-with-the-trump-admin-may-actually-help-it-sales-data-suggests)
...
### #21 [DeepSeek 完成首轮外部融资，估值超 500 亿美元](https://the-decoder.com/deepseek-takes-outside-money-for-the-first-time-at-a-50-billion-valuation)
...
### #22 [Anthropic：智能体编码中专业知识回报持续存在](https://www.anthropic.com/research/claude-code-expertise)
...
### #23 [OpenAI 发布 Deployment Simulation 方法：通过模拟部署预测模型发布前行为](https://openai.com/index/deployment-simulation)
...
### #24 [公开聊天数据能否预测真实世界AI失调？](https://alignment.openai.com/validating-public-evals)
...
### #25 [Meta 解散工程部门引发热议](https://newsletter.pragmaticengineer.com/p/why-is-meta-destroying-its-engineering)
...
### #26 [毕业生陷入AI检测荒诞循环：手写摘要被判99%AI率，AI写部分0%](https://mp.weixin.qq.com/s/DRzNIiojGLO-iqqPyJ7f8Q)
...
### #27 [WorkBuddy日活飙升至行业第二的3-4倍，非技术用户涌入](https://mp.weixin.qq.com/s/iAgbUzPrsbpqvu4s2XiH0g)
...
### #28 [OpenAI 的领先优势正在快速缩小](https://garymarcus.substack.com/p/openais-lead-is-dwindling-fast)
...
### #29 [前沿大模型后训练配方回顾：与 Finbarr Timbers 对谈](https://www.interconnects.ai/p/frontier-post-training-recipe-review)
